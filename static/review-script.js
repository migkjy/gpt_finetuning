...
function updateTable(data) {
        ...
        data.forEach((row, index) => {
            ...
            // Create a button for regeneration
            ...
            deleteBtn.onclick = () => deleteRow(index); // Bind the onclick event to the regenerateRow function

            // Create a cell for the button and append it to the table row
